...
import { Music, BookOpen, Target, Store, Wrench, Star } from 'lucide-react';
...
export default function Blog() {
  ...
  const posts = [
    ...
    },
    {
      ...
      excerpt: 'A simple guide on what to buy and what you\'ll learn as a beginner guitarist in NZ',
      date: 'April 20, 2025',
      readTime: '15 min read',
      category: 'Guides',
