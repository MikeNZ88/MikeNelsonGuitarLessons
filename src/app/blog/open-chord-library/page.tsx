                  ...
                  <div className="bg-green-50 p-6 rounded-lg">
                    ...
                    <div className="bg-white p-4 rounded-lg border border-green-200">
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg border mb-4">
                        <div className="text-xs text-gray-500 text-center mb-2">← Scroll to see all beats →</div>
                        <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                          <div className="flex items-start space-x-3 min-w-max pl-4 pr-8">
                          {/* Count label */}
                        ...
                        <div className="flex justify-center mt-4 mb-3">
                          <button
                            ...
                            className="px-4 py-2 text-sm bg-orange-100 text-orange-800 rounded-md hover:bg-orange-200 transition-colors"
                          >
                        ...
                        {/* Legend */}
                      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-xs mb-3">
