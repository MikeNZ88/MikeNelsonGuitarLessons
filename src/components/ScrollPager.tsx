      ...
      <div className="relative">
        ...
        {!collapsed && (
          <div className="pointer-events-auto flex flex-col items-end">
            <div className="flex flex-col overflow-hidden rounded-full bg-amber-600/90 text-white shadow-lg backdrop-blur-sm">
              <button
                type="button"
                aria-label="Scroll to top"
                title="Top"
                onClick={handleTop}
                className="w-12 h-12 flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-300"
              >
