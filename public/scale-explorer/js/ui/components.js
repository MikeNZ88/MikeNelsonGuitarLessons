            ...
            if (scaleType === 'natural-minor' || scaleType === 'aeolian') {
                return `
                    <div class="jazz-theory-note">
                        ...
                        <p><strong>Jazz Theory Naming:</strong> Chord functions and quality descriptions in this tool are based on jazz theory conventions, while acknowledging that natural minor doesn't always fit rigid functional categories.</p>
                    </div>
                `;
            }
            ...
            if (scaleType === 'harmonic-minor') {
                return `
                    <div class="jazz-theory-note">
                        ...
                        <p><strong>Jazz Theory Naming:</strong> Chord descriptions are based on jazz theory conventions, while recognizing that harmonic minor operates on classical voice-leading principles rather than purely functional harmony.</p>
                    </div>
                `;
            }
