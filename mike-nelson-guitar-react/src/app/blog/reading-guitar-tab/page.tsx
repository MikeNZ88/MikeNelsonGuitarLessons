      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <img 
              src="https://images.unsplash.com/photo-1564186763535-ebb21ef5277f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" 
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-xl text-gray-600 mb-8">
                Learn guitar tablature through a structured 4-level approach, from basic fret notation to advanced playing techniques and symbols.
              </p>
